...
\hypersetup{
    pdftitle={Uma Proposta de Controle Alternativo do Mouse Centrado na Cabeça do Usuário}
	pdfauthor={João Victor da Silva Dias Canavarro}
}
\fi
...
%%Programa de Pós-Graduação em Ciência da Computação\\[1pt]
%Laboratório de Visualização, Interação e Sistemas Inteligentes\\[1pt]
%Belém -- Pará -- Brazil\\[1pt]
%\begin{figure}
...
\title[Controle Alternativo do Mouse Centrado na Cabeça do Usuário]
% {\Large Uma Proposta de Acionador Externo de Baixo Custo Baseado em Sopro}
{\Large Uma Proposta de Controle Alternativo do Mouse Centrado na Cabeça do Usuário}
\author[ João V. Canavarro ]
{\large \textbf{João Victor da Silva Dias Canavarro}\vspace{.2cm}}

\institute[UFPa]{
\small
Instituto de Ciências Exatas e Naturais\\[1pt]
Faculdade de Computação\\[1pt]
Laboratório de Visualização, Interação e Sistemas Inteligentes\\[1pt]
% Aluno: João Victor da Silva Dias Canavarro
...
\date{\small{30 de Setembro de 2019}}
...
\date{
	\normalsize
	João V. Canavarro (\href{mailto:jvcanavarro@ufpa.br}{\tt jvcanavarro@ufpa.br})\\[1pt]
	Universidade Federal do Pará (UFPA)\\[1pt]
	Belém -- Pará -- Brasil\\
}
\titlepage
\end{frame}
